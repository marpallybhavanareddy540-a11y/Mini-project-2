...
class EscapeRoom { 
    private int lives = 3;     private Scanner sc = new Scanner(System.in); 
    ...
    // Room 1     private boolean room1() {         while (checkLife()) { 
            try { 
                System.out.println("\nRoom 1"); 
                ...
                if (ans == 2) { 
                    System.out.println("Door 1 Unlocked!");                     return true; 
                } else {                     wrongAnswer(); 
                } 
            } catch (InputMismatchException e) {                 System.out.println("Invalid Input!");                 sc.next(); 
            } 
        } 
        return false; 
    } 
 
    // Room 2     private boolean room2() {         while (checkLife()) { 
            try { 
                System.out.println("\nRoom 2"); 
                ...
                if (ans == 2) { 
                    System.out.println("Door 2 Unlocked!");                     return true; 
                } else {                     wrongAnswer(); 
                } 
            } catch (InputMismatchException e) {                 System.out.println("Invalid Input!");                 sc.next(); 
            } 
    ...
    // Room 3     private boolean room3() {         while (checkLife()) { 
            try { 
                System.out.println("\nRoom 3"); 
                ...
                if (ans == 2) { 
                    System.out.println("Door 3 Unlocked!");                     return true; 
                } else {                     wrongAnswer(); 
                } 
            } catch (InputMismatchException e) {                 System.out.println("Invalid Input!");                 sc.next(); 
            } 
    ...
    // Room 4     private boolean room4() {         while (checkLife()) { 
            try { 
                System.out.println("\nFinal Room"); 
...
public class Main {     public static void main(String[] args) { 
        EscapeRoom game = new EscapeRoom();         game.startGame(); 
    } 
} 
OUTPUT 
==================================== 
